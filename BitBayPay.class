...
class bitbayAPI
{
	...
	public function startPayment($params){
		echo callApi("payments", $params, "POST");
	}

	public function getCurrencyPairs(){
		echo callApi("stores/markets");
	}

	public function getPaymentDetails($paymentId){
		echo callApi("payments/".$paymentId);
	}

	public function withdrawalFunds($params){
		echo callApi("outgoing-payments", $params, "POST");
	}
